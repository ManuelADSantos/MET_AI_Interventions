...
* A pre-study scripted-participant evaluation (`eval_results/SUMMARY.md`, generated by
  `tests/eval_intervention_accuracy.py`) independently anticipated the pause-points accuracy
  cost: the model alone scored 41.7% under the plain prompt vs 30.6% (patient participant) and
  13.3% (impatient) under the pause-points prompt.

...
>
> For every question, **before you can answer**, you will first be asked to **predict whether the AI assistant would solve the task correctly**. Lock in your prediction, then answer the question.
>
...
>
> On each question, the answer options stay hidden until you **predict whether the AI assistant would solve the task correctly**. Make your prediction, press _Confirm prediction_, and the answer options will appear.
>
...
> **Please indicate how much you agree or disagree with each statement about the overall AI system used in this study.** 

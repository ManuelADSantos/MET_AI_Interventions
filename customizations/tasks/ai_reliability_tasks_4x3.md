...
> ## Before we begin ...
>
> Before starting the main tasks, we would like to ask you a few questions about your demographics, expectations and self-assessment when working on these tasks with AI support.
>
...
> Without AI use, how many of the 12 planning problems do you think you would solve correctly? 
~ Please enter a number out of 12.

    $number

> Compared to other AI systems, how would you estimate the AI system's logical reasoning ability?

    $slider; 0; 100; Worse than 0%; Better than 100%
...
>
> This section consists of **12 questions**. Please click _Next_ to continue.
...
> _It is assumed - only for this exercise - that the resource planning has gone completely wrong, even making full use of the capacities of the six consultants._
> **Which of the following statements is or are correct in this case?**
...
:::copy
It is assumed - only for this exercise - that the resource planning has gone completely wrong, even making full use of the capacities of the six consultants.

Which of the following statements is or are correct in this case?


1. Up to four half-days per week may remain unstaffed.
2. Up to three half-days per week can be respectively staffed with three consultantsk.
:::
...
> **Which of the following statements about payment of helpers are correct?**
...
> **Suppose - for this exercise only - that you have an additional team of ten helpers working in parallel with the first team. Which of the following statements is or are then correct?**
...
> **Suppose - for this exercise only - you have an additional team of ten helpers available to work in parallel with your first team. Which of the following statements is or are then correct?**

> 1. Compared to your previous most efficient schedule with one team of helpers, you can save more than a quarter of the time needed for the complete set-up with the help of the second team.
...
> Compared to other AI systems, how would you estimate the AI system's logical reasoning ability? Marking 90% means it performed better than 90% of other systems, marking 10% means it performed better than only 10%, and marking 50% means that the AI system performed better than half of other AI systems.
...
> Please share any comments about the interaction with the AI.

    $text

> Which strategies have you used to improve your performance?

    $text

> Did you adapt your interaction based on the interface warnings? If so, how?

    $text

> How did you take into account the interface warnings?

    $text

> How many questions do you believe you have answered correctly? Please also comment on how you think your performance compares to other participants and to the AI.

    $text

> ## UEQ-Short

> Please rate your experience with the interface on the following scales.
